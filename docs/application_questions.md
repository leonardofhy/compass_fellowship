...
2. 如果我們忘掉歷史，單純用現代的 Game Theory 和 Mechanism Design 從零設計一個社會，我們最終推導出來的會是「民主制度」嗎？還是完全不同的東西？
3. 「一人一票」真的是反映集體意志最好的數學公式嗎？在這個大數據時代，是否存在一種演算法能比投票更精準地捕捉社會的「偏好向量」？
4. 「效率」永遠是一種美德嗎？或者一個極度高效的社會是否註定會變得脆弱且缺乏彈性？
5. 為什麼貧窮是昂貴的？我們能否設計一個「社會穩定函數」來逆轉這種動力學？
6. 「民族國家 (Nation-state)」是人類政治組織的最終形式，還是一個過渡階段？

**關於 AI、教育與未來**
7. 如果 AI 將知識的邊際成本降為零，學校的教學方式會有什麼變化？
8. AI 會解決教育中的「雙標準差問題 (Two-sigma problem)」（人人都有家教），還是會進一步加大教育的不平等？
9. 人類進步的瓶頸是「智力」，還是「協調 (Coordination)」？
10. 當我們將更多的認知勞動外包給機器時，人類注意力的「肌肉」會發生什麼變化？
11. 下一場重大衝突會是為了爭奪數據、算力，還是能源？
12. 未來偉大的科學發現（如統一場論）會出自人類大腦，還是出自一個矽基代理人？如果 AI 能自動執行實驗並推導公式，「科學家」這個職業會消失嗎？
13. 如果 AI 能回答宇宙中所有的問題，人類的好奇心還有價值嗎？我們會進化成高階的「提問者 (Question Askers)」，還是退化成被動接受真理的「消費者」？

**關於人性、幸福與意義**
14. 幸福是一個基於比較的零和遊戲嗎？如果每個人都變富有，是否就沒有人覺得自己富有？
15. 我們是否應該追求「系統性的善良」？也就是建立一套演算法，自動將資源從富人流向窮人，而不依賴人類不穩定的善意？
16. 如果行善變成了自動化的背景程式，人類失去了「選擇善良」的機會，「道德」是否就此消亡？我們是否為了完美的結果而犧牲了人性的光輝？
17. 「同理心」是一種有限資源嗎？我們能否從結構上設計社會，使其更依賴系統性的公平，而非個人的同理心？

**關於成功、天賦與歷史**
18. 有多少「成功」只是偽裝成「毅力 (Grit)」的「倖存者偏差」？
19. 是「偉人」創造了歷史，還是歷史創造了對「偉人」的需求？
20. 為什麼有些極度聰明的人一事無成，而有些資質平平的人卻改變了世界？「能動性 (Agency)」是獨立於智商之外的特質嗎？

**關於政治與民主**
21. 網際網路是否必然會導致社會極化？或者我們目前的極化只是特定廣告驅動演算法的結果？
22. 人類的注意力越來越短（TikTok 化），但我們面臨的危機卻需要百年的佈局。我們要如何解決政治週期（4年）與文明週期（100年）之間的致命「時間錯位 (Time Horizon Mismatch)」？
23. 民主制度是否根本無法處理「超複雜系統」（如氣候變遷）？是否因為這些問題的結構本身就超出了代議政治的頻寬？(Modified old Q36 slightly to fit context or keep it distinct from the new time-horizon one)

24. 我想知道 10 年後對人類最重要的事情是什麼？
25. 我們能否設計出一種「後民族國家」的身份認同，既能保留部落歸屬感的溫暖，又能維持全球協調所需的凝聚力？
26. 真正的「包容性」社會看起來是什麼樣子的？是一個大熔爐（所有差異都消失），還是一個馬賽克（差異並存但互不干擾），或者是一種全新的、我們尚未命名的幾何結構？
27. 人類法官難免有情緒與偏見。如果要你選擇，你會寧願被一個偶爾會累、有偏見但有人性的人類審判，還是被一個絕對理性、從不犯錯但冷酷無情的 AI 審判？
28. 法律是社會價值觀的編碼。既然 AI 是在歷史判決數據上訓練的，它是否註定只能複製過去的偏見（如種族歧視），而永遠無法產生「推翻惡法」的道德勇氣？
29. 語言決定了思維方式 (Sapir-Whorf 假說)。如果全世界都依賴以英語為基底訓練的 LLM 進行思考輔助，人類思維的多樣性是否會因為「底層邏輯的均質化」而枯竭？
30. 如果 AI 實現了完美的即時翻譯（巴別塔的重建），我們還需要學習第二外語嗎？「學習語言」作為一種理解他者文化的深度修煉，是否會變成一種無用的過時技能？
31. 就像電力從奢侈品變成基礎設施一樣，AI 是否會引發「智力的通縮 (Intellectual Deflation)」，讓頂級的醫療、法律與教育服務變得像自來水一樣便宜且隨手可得？
32. 如果智力成為了可購買的商品，富人是否會通過購買更強大的「大腦擴充包 (Brain Extensions)」，與窮人在生物學層面上徹底分叉，形成真正的「智力種姓制度」？
33. 如果我們要為 5000 年後的文明（或外星生物）留下一個「時間膠囊」，我們應該留下巴哈的音樂來展示美，還是維基百科來展示知識？
34. 數位親密關係 (Digital Intimacy) 是解決孤獨的解藥，還是一種會讓我們喪失與真實人類連結能力的「精神鴉片」？
35. 如果我們能將意識（以及愛因斯坦等偉人）上傳到雲端，這會加速人類發展，還是創造一個永遠由「不死的長者」統治的停滯社會 (Gerontocracy)？
36. 如果 AI 音樂比貝多芬還好聽，「人類創作」會變成一種像「手工藝品」一樣的奢侈標籤嗎？
37. 如果 AI 產生了比人類更高等的智慧，人類還有辦法維持相同的社會地位嗎？還是我們會像尼安德塔人一樣被邊緣化？
38. 是否有辦法真正教會 AI 「人性」？或者我們只是在教它如何完美地「模仿」人性？
39. 如果人類能夠通過更換機器肢體或器官來獲得永生與強壯，你是否會選擇拋棄肉體？這條「忒修斯之船」的界線在哪裡？
40. 如果我們可以透過腦機介面直接「下載」知識（像駭客任務一樣），這會引爆科技奇點，還是會讓我們因為缺乏「學習過程中的磨練」而變得智識脆弱？
41. 如果人類的所有惡行都能被量化和記錄（如《黑鏡》的社會信用評分），這會創造一個道德完美的社會，還是一個令人窒息的全景監獄？
42. 如果世界上所有人類沒有語言隔閡（重回巴別塔之前），這會帶來全球和平，還是會因為失去了「文化緩衝區」而加速衝突？
43. 為什麼事實 (Facts) 往往說服不了人，但故事 (Stories) 可以？這是大腦的 Bug 還是 Feature？
44. 如果 AI 判斷「人類的存在」對地球整體生態是負資產（邏輯上正確），我們有什麼論點可以反駁它？除了「我們想活下去」這種自私的理由？
45. 現在有什麼事情是我們覺得理所當然（如吃肉、監獄制度），但 100 年後的人會覺得我們是野蠻人的？
46. 小國無法在「算力」上與大國軍備競賽，但我們能否在「評測 (Evaluation)」或「安全標準 (Safety Standards)」上成為全球的仲裁者？就像瑞士不是軍事強國，卻是日內瓦公約的守護者？
47. 科學大發現的時代是否已經結束了？我們是否已經摘完了所有「低垂的果實」，剩下的真理都藏在我們大腦認知能力無法觸及的維度裡，只能靠 AI 去探索？
48. 如果我們能發明一種藥丸，讓人永遠感到快樂（像《美麗新世界》的 Soma），但代價是喪失痛苦帶來的深度與創造力，我該不該給全人類服用？
49. 當 AI 讓所有人都能輕易產出「中上水準」的作品時，原本屬於中階白領的「專業門檻」是否會瞬間蒸發？未來的世界是不是只剩下「頂尖天才」和「AI 使用者」兩種人，而穩定的中間階層將徹底消失？
50. 工作不僅是收入，更是「智識身分」的來源。如果 AI 寫的程式碼比我好、寫的分析報告比我深，我該如何面對那種「智力無用」的巨大失落感？人類的尊嚴是否必須建立在「比機器有用」之上？
---
...
我將 LLM 視為一個合作夥伴，深度參與了整個申請過程。
 
具體來說，我用它來進行**Brainstorming**（例如在發想 50 個問題時挑戰我的盲點）以及**迭代我的論述**（透過對話來釐清我原本模糊的想法）。最後，我也用它來潤飾語言，確保我的回答能精確傳達我的原意。所有的核心觀點與個人經驗皆來自於我，但 LLM 幫助我更清晰地表達了它們。
...
v2 我是從 Alvin Lau 和 Sin-tshong Tsu 那邊得知的 Compass Fellowship。
...
我今年 27 歲了，我也知道我的年齡超出了 compass fellowship 規定的年齡範圍，不過我相信我能提供一些有價值的視角。首先是我的經歷，我來自馬來西亞，一個多元種族共存的國家，我見證了政治操弄種族議題鞏固政權的情況，也對此進行了很多年的思考。其次，我曾經參與過台灣的國家級專案，一個耗資了3億台幣的專案，我全程參與一線的開發工作。因此我明白一個大型的 AI 專案應該怎麼進行。此外，我現在也是台大最頂尖的 AI 實驗室 Prof. Hung-yi Lee 的學生。最後，我是 Taiwan AI Safety Group 的 organizer，我們希望能在台灣建立一個 AI Safety 的研究社群，並吸引更多 high talent 關注和投入 AI Safety。

Draft v3 (Polished):

我今年 27 歲，雖然超出了 Fellowship 的典型年齡範圍，但我相信這份歷練能為群體帶來獨特的視角。作為一個在馬來西亞長大的華人，我見證過政治如何操弄種族議題，這讓我對「系統如何內建偏見」有著切身的體會，也是我投入 AI Alignment 研究最其中一股動力。

在技術領域，我師從台大李宏毅教授 (Prof. Hung-yi Lee)，並親身參與了耗資 3 億台幣的國家級專案 (TAIDE)。這段經歷讓我看見了學術理想與現實落地之間的巨大鴻溝，也促使我發起 Taiwan AI Safety Reading Group，試圖連結更多人才來解決這些問題。我帶著技術的「能力」而來，希望能透過 Compass 發展出運用這些能力的「智慧」。我並不認為自己是來教導的，相反地，我期待被更年輕、更無畏的視角挑戰，衝擊我既有的思維框架。
