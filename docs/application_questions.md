...
Draft v4
最近我加入了台大最頂尖的 AI Lab，然後我觀察到了一些有趣的現象，首先即使是今天，大學裡的實驗室也依然採取類似中世紀的學徒制，一般會有老師帶領學生做研究。我想這表示制度的現代化發展並沒有我們預期的那樣快。因為依然有許多隱性的知識沒有通過論文或者其他媒介傳播。比如怎麼判斷一個研究主題是否值得研究，如何避免研究上的坑等。這也讓我進一步思考到底現代化的社會相較於以前的差異。
首先，我們今天創造了極為發達的工具（GPU、LLM），可以用超越人類的速度處理資訊。但諷刺的是，我們用來『運用這些工具』的制度——像是 peer review、tenure track——依然是幾百年前的設計。更根本的是，那些最關鍵的隱性知識（如研究品味），至今仍無法被規模化傳播，只能透過古老的師徒制口耳相傳。這讓我意識到，我們的工具跑得太快，但我們自己還沒跟上。學術制度可能還需要幾次根本性的變革，而我們在發揮智力槓桿這條路上，還遠遠沒有走到盡頭。
